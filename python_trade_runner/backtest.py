...
from .constants import CLOSED, LONG, SHORT, FEESTAKER, FEESMAKER
from .trade import Trade, gain
from .setup import Setup
from .chart import Chart
from .utils import FEES, Interval, Exchange, Symbol
from .infos import PerformanceManager


def base_add_trade(b, t:Trade) -> list[Trade]:
    """
...
def base_new_trade_filter(trade_list:list[Trade]) -> list[Trade]:
    """
...
class Backtest(object):
    def __init__(self, setup_list:list[Setup], risk_for_setup_id:dict, start_datetime:datetime, end_datetime:datetime, window_size:int, initial_balance:float,
        ...
        self.performance_manager = PerformanceManager(self.exchange, self.symbol, self.interval, self.trade_list, self.archieved_trades)
